     ...
     showLabel: function() {
       ...
       window.setTimeout(function() {
         ...
         if (self.$element.is("textarea")) {
           ...
           /*
             BUG FIX #78: The way Chrome handles textarea padding makes the label overlap the user text in the
             input. Gave the background of the floatlabel a white background and adjust the position and
             padding slightly
           */
           ...
           if (isWebkit) {
             ...
             self.$label.addClass("floatlabel-textarea");
           }
